...
OneButton button[] {{BTN_LEFT, BTN_ACTIVE_LEVEL, BTN_INTERNALPULLUP}, {BTN_CENTER, BTN_ACTIVE_LEVEL, BTN_INTERNALPULLUP}, {BTN_RIGHT, BTN_ACTIVE_LEVEL, BTN_INTERNALPULLUP}, {ENC_BTNB, true, ENC_INTERNALPULLUP}, {BTN_UP, BTN_ACTIVE_LEVEL, BTN_INTERNALPULLUP}, {BTN_DOWN, BTN_ACTIVE_LEVEL, BTN_INTERNALPULLUP}, {ENC2_BTNB, true, ENC2_INTERNALPULLUP}, {BTN_MODE, BTN_ACTIVE_LEVEL, BTN_INTERNALPULLUP}};
