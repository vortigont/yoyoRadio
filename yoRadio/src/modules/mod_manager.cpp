...
static constexpr std::array<const char*, 1> wdg_list = {
  "placeholder"
};

static constexpr const char* T_ui_page_module_mask    = "ui_page_module_*";
static constexpr const char* T_ui_pages_modlist       = "youi.pages.modules_list";
...
void ModuleManager::setHandlers(){
  ...
  // handler for module's configuration page generators
